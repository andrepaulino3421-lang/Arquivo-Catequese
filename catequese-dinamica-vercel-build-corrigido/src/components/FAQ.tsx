...
const faqs = [
  {
    ...
    a: 'O material é 100% digital. Você receberá o acesso para baixar os arquivos em formato PDF imediatamente após a confirmação do pagamento no seu e-mail.'
  },
  {
  ...
  },
  {
    ...
    a: 'Não. A maioria das dinâmicas exige apenas materiais simples e de fácil acesso, como papel, caneta, Bíblia ou objetos cotidianos.'
  },
  {
  ...
  },
  {
    ...
    a: 'Para pagamentos via Pix ou Cartão de Crédito, o acesso é enviado na mesma hora para o e-mail cadastrado na hora da compra. Se for boleto, pode levar até 3 dias úteis.'
  }
];
