...
const BASIC_CHECKOUT_URL = 'https://pay.kirvano.com/78cbb238-484f-4953-8810-f9653a8ee0d5';
const COMPLETE_CHECKOUT_URL = 'https://pay.kirvano.com/0928fab2-2cf4-4919-82eb-883984011d96';
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-text text-lg max-w-2xl mx-auto mb-8">
            Invista nos seus encontros de catequese com um valor acessível e receba os PDFs diretamente no seu e-mail.
          </p>
          ...
          <div className="flex-1 bg-white rounded-2xl p-8 border border-[#EBE6DC] shadow-sm flex flex-col justify-between max-w-md mx-auto lg:mx-0 w-full lg:mt-6">
            <div>
              ...
              <ul className="space-y-4 mb-8">
                {['+450 Dinâmicas de Catequese', 'Entrega imediata por e-mail', 'Formato PDF', 'Garantia de 7 dias'].map((item, i) => (
            ...
            <a
              ...
              className="block text-center w-full py-4 text-primary font-bold border-2 border-primary rounded-xl hover:bg-primary/5 transition-colors uppercase text-sm tracking-wide"
            >
              Quero Esse Pacote
            </a>
          </div>
          ...
          <div className="flex-[1.2] bg-white rounded-2xl p-8 border-2 border-primary shadow-xl flex flex-col justify-between max-w-md mx-auto lg:mx-0 w-full relative z-10">
            ...
            <div>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="block text-center w-full py-4 text-white font-bold bg-primary hover:bg-primary-hover rounded-xl shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-0.5 uppercase text-sm tracking-wide mb-3"
              >
