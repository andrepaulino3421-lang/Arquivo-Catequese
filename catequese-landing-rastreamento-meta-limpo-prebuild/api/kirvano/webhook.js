import { sendMetaEvent, getPurchaseValue } from '../_meta.js';
  ...
  try {
    ...
    if (access.is_approved && (access.basic_access || access.complete_access || access.activities365_access || access.uno_da_fe_access || access.lifetime_access)) {
      ...
      metaPurchase = await sendMetaEvent({
        ...
        customData: {
          // Rastreamento limpo: enviar apenas valor e moeda para a Meta.
          // Não enviar nome do produto, categoria religiosa, plano, bônus ou descrição.
          currency: 'BRL',
          value: purchaseValue,
        },
      });
